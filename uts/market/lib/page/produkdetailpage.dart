...
with TickerProviderStateMixin{
  Widget build(BuildContext context){
    return Scaffold(
      ...
      body: _buildProdukDetailpage(context),
      bottomNavigationBar: _buildBottomNavigationBar(),
    );
  }

  _buildProdukDetailpage(BuildContext context){
            ...
            child: Stack(
              children: <Widget>[
                TabBarView(
                  ...
                  children: <Widget>[
                    Image.network(
                      "https://img.taste.com.au/q5AO4VFI/w720-h480-cfill-q80/taste/2016/11/malaysian-fried-chicken-ayam-goreng-108899-1.jpeg",
                    ),
                    Image.network(
                      "https://img.taste.com.au/q5AO4VFI/w720-h480-cfill-q80/taste/2016/11/malaysian-fried-chicken-ayam-goreng-108899-1.jpeg",
                    ),
